...
export const createEvent = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      // 1. Destructure hasPro out so it doesn't get inserted into the DB
      ...
      const themeColor = hasPro ? eventData.themeColor : defaultColor;
      ...
      // Create event using eventData (which no longer contains hasPro)
